...
## Binary Tree Friends:
  ...
  *Implementation*</br>
  The implementation is in Python and it is using Object Oriented concepts. The class BinaryTree is used to define an object that have the 3 attributes of a node in a Binary Tree:
