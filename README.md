...
----------------------------------------------------------------------------------------------------------------------------------------
  ...
  -number
  -card_type
  The class player has 4 attributes: name- name of the player,nr_card- gives the number of the card,cards- gives the card that the player has in his hands, war_hand- is a list that is used when war is happening.  
